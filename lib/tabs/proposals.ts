...
export function proposalDto(proposal: SettlementProposal): SettlementProposalResponse {
  ...
  return {
    ...
    registeredAt: proposal.registeredAt?.toISOString() ?? null,
    registrationTxHash: proposal.registrationTxHash,
    cancellationTxHash: proposal.cancellationTxHash,
    onchainCancelledAt: proposal.onchainCancelledAt?.toISOString() ?? null,
